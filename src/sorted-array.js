...
const sortedByRating = () => {
  ...
  arrayCopy.sort((a,b) => parseInt(b.ratingReviews) - parseInt(a.ratingReviews))
  return arrayCopy;
};
...
const sortedByPrice = () => {
  ...
  arrayCopy.sort((a,b) => {
    ...
    if (typeof a.price !== 'string') {
      priceA = priceA.newUan
    }
    
    if (typeof b.price !== 'string') {
      priceB = priceB.newUan
    }

    return  parseInt(priceB.replace(' ', '')) - parseInt(priceA.replace(' ', ''))
  })
  return arrayCopy;
  };
